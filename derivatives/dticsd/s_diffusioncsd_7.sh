...
dwi2response dhollander \
  /home/brain/research/DATA/BIDS/preproc/test/sub-032301_ses-01_dir-PA_dwi_aftereddy.mif \
  RF_WM_PA.txt RF_GM_PA.txt RF_CSF_PA.txt \
  -mask /home/brain/research/DATA/BIDS/preproc/test/b0_1_PA_aftereddy_brain_mask.nii.gz \
